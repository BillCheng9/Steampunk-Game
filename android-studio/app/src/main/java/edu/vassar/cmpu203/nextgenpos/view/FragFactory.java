...
public class FragFactory extends FragmentFactory {

    private static final String VIEW_PACKAGE = FragFactory.class.getPackage().getName(); // package where all all fragments reside
     ...
     */
    public FragFactory(MainActivity controller){
